...
#set Header
Label(window,text='WEBSITE BLOCKER',font=('bold',15),fg='hotpink').pack()
Label(window,text='Developed By Annapurna',font=('bold',12),fg='purple').pack(side=BOTTOM)
...
Button(window,text='Block',font=('bold',10),bg='pink',fg='black',command=block).place(x=150,y=100)
Button(window,text='Un Block',font=('bold',10),bg='cyan',fg='black',command=unblock).place(x=270,y=100)
Button(window,text='Exit',font=('bold',10),bg='grey',fg='cyan',command=close).place(x=400,y=100)
window.mainloop()